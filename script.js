...
const uiCopy = {
  zh: {
    ...
    aiReady: "AI 个性化结果已生成。",
    aiFallback: "当前使用默认结果卡；启动 AI 后端并配置 OPENAI_API_KEY 后可生成个性化结果。",
  ...
  en: {
    ...
    aiFallback: "Using the default result card. Run the AI server with OPENAI_API_KEY to personalize it.",
